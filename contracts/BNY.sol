...
contract BNY   {
    ...
    function passiveIncomeInvestment(uint256 _amount) public returns (uint256) {
        ...
        passiveInvestors[passiveInvestorIndex-1] = PassiveIncome(
            msg.sender,
            _amount,
        ...
        _amount,
            passiveInvestorIndex-1,
            block.timestamp.add((dayseconds * 365)),
            passiveInvestors[passiveInvestorIndex-1].dailyPassiveIncome,
            passiveInvestors[passiveInvestorIndex-1].investmentTimeStamp
        );
